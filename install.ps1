...
# One-liner: irm https://raw.githubusercontent.com/N30Z/Claude-win11/main/install.ps1 | iex
...
if (-not $gitCmd) {
    ...
    Write-Host "  irm https://raw.githubusercontent.com/N30Z/Claude-win11/main/install.ps1 | iex" -ForegroundColor Gray
    Write-Host ""
    exit 1
}
...
$mainInstaller = Join-Path $InstallPath "install-all.ps1"
...
if (-not (Test-Path $mainInstaller)) {
    ...
    Write-Host "  irm https://raw.githubusercontent.com/N30Z/Claude-win11/main/install.ps1 | iex" -ForegroundColor White
    Write-Host ""
    exit 1
}
...
try {
    Write-Host "Launching install-all.ps1..." -ForegroundColor Cyan
